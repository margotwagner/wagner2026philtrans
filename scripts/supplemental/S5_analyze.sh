...
CONDITION_ROOTS=(
  ...
  "$RUNS_ROOT/cyclic_shift/alpha0p00"
  "$RUNS_ROOT/cyclic_shift/alpha0p25"
  "$RUNS_ROOT/cyclic_shift/alpha0p50"
  "$RUNS_ROOT/cyclic_shift/alpha0p75"
  "$RUNS_ROOT/cyclic_shift/alpha1p00"

  "$RUNS_ROOT/mexican_hat/k0"
  "$RUNS_ROOT/mexican_hat/k5/alpha0p00"
  "$RUNS_ROOT/mexican_hat/k5/alpha0p25"
  "$RUNS_ROOT/mexican_hat/k5/alpha0p50"
  "$RUNS_ROOT/mexican_hat/k5/alpha0p75"
  "$RUNS_ROOT/mexican_hat/k5/alpha1p00"
)
